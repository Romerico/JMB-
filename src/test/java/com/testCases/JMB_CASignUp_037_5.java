...
public class JMB_CASignUp_037_5 extends BaseClass {
...
//AC05: initially It should display textbox empty."
    ...
    public void verifyYourEmailPage() throws IOException, NoSuchElementException {
        ...
        signUpPage.setSubmitButton();
            ...
            logger.info("validate of initially textboxes are empty");
            verifyEmailPage.textBoxesEmpty();


        softassert.assertAll();
        logger.info("Completed JMB_CASignUp_037_5");
    }
}
