...
//AC01: It should display message"Please enter a valid verification code.".
    ...
    @Test(priority = 43)
    public void verifyYourEmailCodeLessThan4() throws IOException, NoSuchElementException, InterruptedException {
        ...
        verifyEmailPage.validateErrorMessageMail("Please enter a valid verification code.", "JMB_CASignUp_042_2");
