...
public class JMB_CASignUp_049 extends BaseClass {
    SoftAssert softassert = new SoftAssert();

//"This test case is testing whether a candidate can enter maximum 10  location.
...
//AC01: It should display list of previously selected locations below the Next button."
    ...
    @Test(priority = 53)
    public void enterUpTo10Location() throws IOException, NoSuchElementException, InterruptedException {


        logger.info("Started Candidate- Where are you looking for a job? page  - Location - Enter 10 Location");
        ...
        ca_jobLocationsPage.chooseRandom10();
        ...
        if(ca_jobLocationsPage.getListLocation()){
            ...
            captureScreen(driver, "JMB_CASignUp_049");
        }


        softassert.assertAll();
        logger.info("Completed JMB_CASignUp_049");
    }
}
