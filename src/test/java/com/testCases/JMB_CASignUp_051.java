...
public class JMB_CASignUp_051 extends BaseClass {
    SoftAssert softassert = new SoftAssert();

//"This test case is testing whether a candidate can click on next button.
...
//AC01: It should navigate to  next page."



    @Test(priority = 55)
    public void locationsNextButtonRedir() throws IOException, NoSuchElementException, InterruptedException {


        logger.info("Started Candidate -Where are you looking for a job? Page - Next Button");
        ...
        logger.info("extract title from current page");
        ...
        logger.info("Completed JMB_CASignUp_051");
    }
}
